...
- advanced risk metrics and detailed information to every trade
- visualization of price, entry and exit positions
- monte carlo testing for evaluating statistical significance
- papertrading with simulated money on live-market data
- automatic order placement via direct websocket connection to your exchange
- start and stop up to 300 independant instances for live and papertrading
...
<img width="400" height="200" alt="graph" src="https://github.com/user-attachments/assets/aa2b4866-c114-4cbc-88b5-3b255d57c310" />
...
and you can monitor your running instances
<img width="450" height="450" alt="more" src="https://github.com/user-attachments/assets/7b212442-2b36-455f-b407-1732fc7566dd" />
